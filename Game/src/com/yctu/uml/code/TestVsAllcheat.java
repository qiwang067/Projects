...
public class TestVsAllcheat implements ActionListener {
	JDialog dialog;

	TestVsAllcheat(JFrame f) { // 构造方法，从其调用方法中获得对话框的父窗口
		dialog = new JDialog(f, "are you ok", true); // 产生一modal对话框
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd.equals("OK")) {
			try {
				...
				System.out.println();
				System.out.println("Copycat:"+3+" allcheat:"+22);
				System.out.println("---------------------------");
...
//								System.out.println("-----------------------------------");
					...
					System.out.println();
					System.out.println("Copycat:"+count1+" allcheat:"+count4);
					System.out.println("---------------------------");
					count1 = 0;
					count2 = 0;
					count3 = 0;
