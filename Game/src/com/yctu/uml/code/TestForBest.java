...
public class TestForBest implements ActionListener {
	JDialog dialog;

	TestForBest(JFrame f) { // 构造方法，从其调用方法中获得对话框的父窗口
		dialog = new JDialog(f, "are you sure", true); // 产生一modal对话框
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd.equals("OK")) {
			try {
				...
				System.out.println();
				System.out.println("Copycat:"+5+" detective:"+5+" honest:"+5
						+"\n"+"\n"+"allcheat:"+5+" allcorporate:"+5);
				System.out.println("---------------------------");
